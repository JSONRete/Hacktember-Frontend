...
function Nav() {
  ...
  const links = "text-4xl text-slate-900 font-extrabold hover:text-blue-600 hover:underline hover:bg-slate-100 font-display border border-slate-900 px-4 py-2 rounded"
