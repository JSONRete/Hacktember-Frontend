...
function Nav() {
  ...
  const links =
    "text-5xl text-white font-extrabold hover:text-blue-600 hover:underline hover:bg-slate-100 font-display border border-slate-900 px-4 py-2 bg-slate-900";
  ...
  return (
        ...
        {user && (
          <Link>
            <button
              ...
              className="text-6xl bg-red-700 text-white font-extrabold hover:text-red-700 hover:underline  hover:bg-white font-display border border-slate-900 px-4 py-2 rounded"
            >
              Logout
            </button>
          </Link>
    ...
    <div className="bg-slate-900 h-1 mt-5">
      </div>
      </>
  );
}
